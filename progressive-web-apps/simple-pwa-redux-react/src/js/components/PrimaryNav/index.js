        ...
        <div className="container">
          <div className="row">
            <div className="col-xs-3 PrimaryNav-button_nav_container text-center">
              { onPostItem ?
                  <button if="onPostItem" className="btn PrimaryNav-button_nav PrimaryNav-button" onClick={ backToHome.bind(this) }>
                    <i className="ion-arrow-left-c"></i>
                  </button>
                :
                  <button if="!onPostItem" className="btn PrimaryNav-button_nav PrimaryNav-button" onClick={ toggleSidebar.bind(this) }>
