...
;(function(window, document, undefined){
	...
	;
	define("test/css/vwunit", function(){});

	;
	define("test/css/will-change", function(){});

	;
	define("test/css/wrapflow", function(){});

	;
	define("test/dom/createElement-attrs", function(){});

	;
	define("test/dom/dataset", function(){});

	;
	define("test/dom/documentfragment", function(){});

	;
	define("test/dom/hidden", function(){});

	;
	define("test/dom/microdata", function(){});

	;
	define("test/dom/mutationObserver", function(){});

	;
	define("test/elem/bdi", function(){});

	;
	define("test/elem/datalist", function(){});

	;
	define("test/elem/details", function(){});

	;
	define("test/elem/output", function(){});

	;
	define("test/elem/picture", function(){});

	;
	define("test/elem/progress-meter", function(){});

	;
	define("test/elem/template", function(){});

	;
	define("test/elem/time", function(){});

	;
	define("test/elem/track", function(){});

	;
	define("test/elem/unknown", function(){});

	;
	define("test/es5/array", function(){});

	;
	define("test/es5/date", function(){});

	;
	define("test/es5/function", function(){});

	;
	define("test/es5/object", function(){});

	;
	define("test/es5/specification", function(){});

	;
	define("test/es5/strictmode", function(){});

	;
	define("test/es5/string", function(){});

	;
	define("test/es5/syntax", function(){});

	;
	define("test/es5/undefined", function(){});

	;
	define("test/es6/array", function(){});

	;
	define("test/es6/collections", function(){});

	;
	define("test/es6/contains", function(){});

	;
	define("test/es6/generators", function(){});

	;
	define("test/es6/math", function(){});

	;
	define("test/es6/number", function(){});

	;
	define("test/es6/object", function(){});

	;
	define("test/es6/promises", function(){});

	;
	define("test/es6/string", function(){});

	;
	define("test/event/deviceorientation-motion", function(){});

	;
	define("test/event/oninput", function(){});

	;
	define("test/file/api", function(){});

	;
	define("test/file/filesystem", function(){});

	;
	define("test/forms/capture", function(){});

	;
	define("test/forms/fileinput", function(){});

	;
	define("test/forms/fileinputdirectory", function(){});

	;
	define("test/forms/formattribute", function(){});

	;
	define("test/forms/inputnumber-l10n", function(){});

	;
	define("test/forms/placeholder", function(){});

	;
	define("test/forms/requestautocomplete", function(){});

	;
	define("test/forms/validation", function(){});

	;
	define("test/iframe/sandbox", function(){});

	;
	define("test/iframe/seamless", function(){});

	;
	define("test/iframe/srcdoc", function(){});

	;
	define("test/img/apng", function(){});

	;
	define("test/img/crossorigin", function(){});

	;
	define("test/img/jpeg2000", function(){});

	;
	define("test/img/jpegxr", function(){});

	;
	define("test/img/sizes", function(){});

	;
	define("test/img/srcset", function(){});

	;
	define("test/img/webp-alpha", function(){});

	;
	define("test/img/webp-animation", function(){});

	;
	define("test/img/webp-lossless", function(){});

	;
	define("test/img/webp", function(){});

	;
	define("test/input/formaction", function(){});

	;
	define("test/input/formenctype", function(){});

	;
	define("test/input/formmethod", function(){});

	;
	define("test/input/formtarget", function(){});

	;
	define("test/network/beacon", function(){});

	;
	define("test/network/connection", function(){});

	;
	define("test/network/eventsource", function(){});

	;
	define("test/network/fetch", function(){});

	;
	define("test/network/xhr-responsetype-arraybuffer", function(){});

	;
	define("test/network/xhr-responsetype-blob", function(){});

	;
	define("test/network/xhr-responsetype-document", function(){});

	;
	define("test/network/xhr-responsetype-json", function(){});

	;
	define("test/network/xhr-responsetype-text", function(){});

	;
	define("test/network/xhr-responsetype", function(){});

	;
	define("test/network/xhr2", function(){});

	;
	define("test/script/async", function(){});

	;
	define("test/script/defer", function(){});

	;
	define("test/speech/speech-recognition", function(){});

	;
	define("test/speech/speech-synthesis", function(){});

	;
	define("test/storage/localstorage", function(){});

	;
	define("test/storage/sessionstorage", function(){});

	;
	define("test/storage/websqldatabase", function(){});

	;
	define("test/style/scoped", function(){});

	;
	define("test/svg/asimg", function(){});

	;
	define("test/svg/clippaths", function(){});

	;
	define("test/svg/filters", function(){});

	;
	define("test/svg/foreignobject", function(){});

	;
	define("test/svg/inline", function(){});

	;
	define("test/svg/smil", function(){});

	;
	define("test/textarea/maxlength", function(){});

	;
	define("test/url/bloburls", function(){});

	;
	define("test/video/loop", function(){});
